export const experience = [
  ...
  //   period: "2017 — 2019",
  //   description: "Managed on-premise infrastructure and initiated the company's cloud migration strategy.",
  //   achievements: ["Migrated legacy systems to cloud", "Implemented backup automation", "Reduced incident response time by 60%"]
  // }
];